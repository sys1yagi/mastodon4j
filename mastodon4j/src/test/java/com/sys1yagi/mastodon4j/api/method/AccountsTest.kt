...
class AccountsTest {
    ...
    fun getAccount() {
        ...
        val account = accounts.getAccount(1L)
    ...
    fun getVerifyCredentials() {
        val client = MockClient.mock("account.json")
        val accounts = Accounts(client)
        val account = accounts.getVerifyCredentials()
        account.acct shouldEqualTo "test@test.com"
        account.displayName shouldEqualTo "test"
        account.userName shouldEqualTo "test"
    }
    ...
    fun updateCredential() {
        val client = MockClient.mock("account.json")
        val accounts = Accounts(client)
        val account = accounts.updateCredential("test", "test", "test", "test")
        account.acct shouldEqualTo "test@test.com"
        account.displayName shouldEqualTo "test"
        account.userName shouldEqualTo "test"
    }
    ...
    fun updateCredentialWithException() {
        val client = MockClient.ioException()
        val accounts = Accounts(client)
        accounts.updateCredential("test", "test", "test", "test")
    }
    ...
    fun getFollowers() {
        ...
        val accounts = Accounts(client)
        val pageable = accounts.getFollowers(1L)
    ...
    fun getFollowing() {
        val client = MockClient.mock("accounts.json")
        val accounts = Accounts(client)
        val pageable = accounts.getFollowing(1L)
        val account = pageable.part.first()
        account.acct shouldEqualTo "test@test.com"
        account.displayName shouldEqualTo "test"
        account.userName shouldEqualTo "test"
    ...
    fun getStatuses() {
        ...
        val accounts = Accounts(client)
        val pageable = accounts.getStatuses(1, false)
    ...
    fun postFollow() {
        ...
        val accounts = Accounts(client)
        val relationship = accounts.postFollow(1L)
    ...
    fun postUnFollow() {
        val client = MockClient.mock("relationship.json")
        val accounts = Accounts(client)
        val relationship = accounts.postUnFollow(1L)
        relationship.id shouldEqualTo 3361
        relationship.isFollowing shouldEqualTo true
        relationship.isFollowedBy shouldEqualTo false
        relationship.isBlocking shouldEqualTo false
    ...
    fun postBlock() {
        val client = MockClient.mock("relationship.json")
        val accounts = Accounts(client)
        val relationship = accounts.postBlock(1L)
        relationship.id shouldEqualTo 3361
        relationship.isFollowing shouldEqualTo true
        relationship.isFollowedBy shouldEqualTo false
        relationship.isBlocking shouldEqualTo false
    ...
    fun postUnblock() {
        val client = MockClient.mock("relationship.json")
        val accounts = Accounts(client)
        val relationship = accounts.postUnblock(1L)
        relationship.id shouldEqualTo 3361
        relationship.isFollowing shouldEqualTo true
        relationship.isFollowedBy shouldEqualTo false
        relationship.isBlocking shouldEqualTo false
    ...
    fun postMute() {
        val client = MockClient.mock("relationship.json")
        val accounts = Accounts(client)
        val relationship = accounts.postMute(1L)
        relationship.id shouldEqualTo 3361
        relationship.isFollowing shouldEqualTo true
        relationship.isFollowedBy shouldEqualTo false
        relationship.isBlocking shouldEqualTo false
    ...
    fun postUnmute() {
        val client = MockClient.mock("relationship.json")
        val accounts = Accounts(client)
        val relationship = accounts.postUnmute(1L)
        relationship.id shouldEqualTo 3361
        relationship.isFollowing shouldEqualTo true
        relationship.isFollowedBy shouldEqualTo false
        relationship.isBlocking shouldEqualTo false
    ...
    fun getRelationships() {
        ...
        val accounts = Accounts(client)
        val relationships = accounts.getRelationships(listOf(1L))
    ...
    fun getRelationshipsWithException() {
        val client = MockClient.ioException()
        val accounts = Accounts(client)
        accounts.getRelationships(listOf(1L))
    }
    ...
    fun getAccountSearch() {
        ...
        val accounts = Accounts(client)
        val result = accounts.getAccountSearch("test")
    ...
    fun getAccountSearchWithException() {
        val client = MockClient.ioException()
        val accounts = Accounts(client)
        accounts.getAccountSearch("test")
    }
}