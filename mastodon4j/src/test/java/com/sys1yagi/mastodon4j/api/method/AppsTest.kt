...
class AppsTest {
    ...
    fun getOAuthUrl() {
        ...
        url shouldEqualTo "https://mastodon.cloud/oauth/authorize?client_id=client_id&redirect_uri=urn:ietf:wg:oauth:2.0:oob&response_type=code&scopes=read write follow"
    }
